...
export const CloudMedium: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
<svg viewBox="0 0 200 100" width="54" height="27" opacity={0.9} xmlns="http://www.w3.org/2000/svg" {...props}>
  <path 
