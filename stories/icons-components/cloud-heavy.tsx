...
export const CloudHeavy: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
<svg viewBox="0 0 200 100" width="60" height="30" opacity={1} xmlns="http://www.w3.org/2000/svg" {...props}>
  <path 
